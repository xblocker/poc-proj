...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The Futu Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "Futu Core"
...
#define PACKAGE_NAME "Futu Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Futu Core v0.1.3"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "Futu"
