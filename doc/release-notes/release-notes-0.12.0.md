...
Then, to tunnel a SSL connection on 6720 to a RPC server bound on localhost on port 6721 do:

    stunnel -d 26720 -r 127.0.0.1:6721 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /bitcoinrpc>
        ...
        ProxyPassReverse http://127.0.0.1:6720/
