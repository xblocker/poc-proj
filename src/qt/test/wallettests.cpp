...
//
//     src/qt/test/test_fermat-qt -platform xcb      # Linux
//     src/qt/test/test_fermat-qt -platform windows  # Windows
//     src/qt/test/test_fermat-qt -platform cocoa    # macOS
void TestGUI()
{
...
void WalletTests::walletTests()
{
    ...
    if (QApplication::platformName() == "minimal") {
        ...
        QWARN("Skipping WalletTests on mac build with 'minimal' platform set due to Qt bugs. To run AppTests, invoke "
              "with 'test_fermat-qt -platform cocoa' on mac, or else use a linux or windows build.");
        return;
    }
#endif
    TestGUI();
